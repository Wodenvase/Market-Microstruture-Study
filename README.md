...
- Demo outputs included: `data/sim_demo.csv`, `python/price_returns.png`, `python/rolling_vol.png`.
- Demo summary: 4999 returns; Hill tail estimate noisy at this sample size; rough Hurst ~0.52.
